...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Nov-2019 às 03:44
...
CREATE TABLE `ambiente` (
  ...
  `edificio_idEdificio` int(11) DEFAULT NULL,
  `tipoAmbiente_idTipoAmb` int(11) DEFAULT NULL
...
INSERT INTO `ambiente` (`idAmbiente`, `referencia`, `edificio_idEdificio`, `tipoAmbiente_idTipoAmb`) VALUES
(2, 'Programação 1', 1, 2),
(6, '', 4, 6),
(9, '01', 1, 1),
(10, 'Lateral Direito', 1, 4),
(17, 'De Teste', 5, 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `categoriaocorrencia`
--
...
--
-- Extraindo dados da tabela `categoriaocorrencia`
--

INSERT INTO `categoriaocorrencia` (`idCategoria`, `nomeCategoria`) VALUES
(1, 'Predial'),
(2, 'Hidráulica'),
(3, 'Energia'),
(4, 'Natural');
...
CREATE TABLE `edificio` (
  ...
  `descEdificio` varchar(255) DEFAULT NULL,
  `nomeEdificio` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `edificio` (`idEdificio`, `descEdificio`, `nomeEdificio`) VALUES
(1, 'Prédio que serve de recursos para os cursos Técnico em Informática e Bacharelado em Ciência da Computação.', 'Prédio de Tecnologia da Informação'),
(4, 'Refeitório universitário do Campus, localizado acima do Prédio de Tecnologia da Informação.', 'Refeitório'),
(5, 'Primeiro prédio construído no IFSULDEMINAS Campus Muzambinho, ainda na época de Escola Agrotécnica Federal de Muzambinho - EAF MUZ. Localizado acima do refeitório.', 'Prédio Pedagógico do H');
...
CREATE TABLE `estado` (
  ...
  `siglaEstado` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `funcao` (
  ...
  `descFuncao` varchar(255) DEFAULT NULL,
...
INSERT INTO `funcao` (`idFuncao`, `descFuncao`, `nomeFuncao`) VALUES
(1, 'Usuários criam conta no sistema, e abrem ocorrências.', 'Usuário'),
(3, 'Responsáveis têm acesso às Ocorrências abertas e geram ordens de serviço para serem avaliadas e executadas.', 'Responsável'),
(4, 'Supervisores emitem relatórios gerenciais e acompanham como os trabalhos estão sendo executados.', 'Supervisor');

-- --------------------------------------------------------

--
-- Estrutura da tabela `marcaequipamento`
--
...
--
-- Extraindo dados da tabela `marcaequipamento`
--

INSERT INTO `marcaequipamento` (`idMarca`, `nomeMarca`) VALUES
(2, 'IBBL');
...
CREATE TABLE `pessoa` (
  ...
  `numeroLogradouro` varchar(255) DEFAULT NULL,
...
INSERT INTO `pessoa` (`idPessoa`, `bairro`, `cpf`, `email`, `logradouro`, `nomePessoa`, `numeroLogradouro`, `senha`, `telefone`, `cidade_idCidade`, `funcao_idFuncao`, `tipo_idTipo`, `sexo_idSexo`) VALUES
(1, 'Jardim Morada do Sol', '321.123.456-79', 'lucas@hotmail.com', 'Rua Novo Amanhecer', 'Lucas Magalhães Prado', '34', '12345', '(35) 3571-4212', 1233, 1, 1, NULL),
(2, 'Jardim Por do Sol', '234.123.124-45', 'kadu.kaduzin@hotmail.com', 'Rua Lalala', 'Carlos Eduardo', '65', '23343', '(35) 3475-1234', 2073, 1, 4, NULL),
(7, 'Centro', '236452357', 'lucas@lukinhas.com', 'Rua Hahaha', 'Cristiano', '56', '12345', '326485274', 2073, 4, 2, NULL),
(9, 'Jardim Itália', '114', 'ksadhf', 'Rua Nápolis', 'Joãozim Ruela', '56', '202cb962ac59075b964b07152d234b70', '123789', 2073, 1, 1, 2);
...
--
-- Estrutura da tabela `tipoambiente`
--

CREATE TABLE `tipoambiente` (
  `idTipoAmb` int(11) NOT NULL,
  `nomeTipoAmb` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tipoambiente`
--

INSERT INTO `tipoambiente` (`idTipoAmb`, `nomeTipoAmb`) VALUES
(1, 'Sala'),
(2, 'Laboratório'),
(3, 'Auditório'),
(4, 'Corredor'),
(6, 'Área de Convívio Social');
...
CREATE TABLE `tipoequipamento` (
  `idTipoEquip` int(11) NOT NULL,
  `nomeTipoEquip` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tipoequipamento` (`idTipoEquip`, `nomeTipoEquip`) VALUES
(2, 'Bebedouro'),
(3, 'Data Show'),
(4, 'Bancada');
...
INSERT INTO `tipopessoa` (`idTipo`, `nomeTipo`) VALUES
(1, 'Aluno'),
(2, 'Professor'),
(3, 'Funcionário'),
(4, 'Visitante');
...
ALTER TABLE `ambiente`
  ...
  ADD KEY `FKlkb5wui1p2rm1spu1yushf6fh` (`edificio_idEdificio`),
  ADD KEY `FKe3on8u9wcmnf719sgfkmf8ynb` (`tipoAmbiente_idTipoAmb`);

--
-- Índices para tabela `categoriaocorrencia`
--
...
ALTER TABLE `cidade`
  ...
  ADD KEY `FKdvvk7e44v45yxfg4n6u1s98y2` (`estado_idEstado`);
...
--
-- Índices para tabela `marcaequipamento`
--
ALTER TABLE `marcaequipamento`
...
ALTER TABLE `pessoa`
  ...
  ADD KEY `FK73exe60i580krixmc6mcl9rwj` (`cidade_idCidade`),
  ADD KEY `FKke72oqk2bq25k8krl23i19ajk` (`funcao_idFuncao`),
  ADD KEY `FK31rn4jl0u0smx6m9kx45nrckq` (`tipo_idTipo`),
  ADD KEY `FKn756mtef1bbaaki22794laa8g` (`sexo_idSexo`);
...
--
-- Índices para tabela `tipoambiente`
--
...
--
ALTER TABLE `ambiente`
  MODIFY `idAmbiente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de tabela `categoriaocorrencia`
--
ALTER TABLE `categoriaocorrencia`
...
--
ALTER TABLE `edificio`
  MODIFY `idEdificio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT de tabela `marcaequipamento`
--
ALTER TABLE `marcaequipamento`
...
--
-- AUTO_INCREMENT de tabela `tipoambiente`
--
ALTER TABLE `tipoambiente`
  MODIFY `idTipoAmb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `tipoequipamento`
--
ALTER TABLE `tipoequipamento`
  MODIFY `idTipoEquip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `ambiente`
  ADD CONSTRAINT `FKe3on8u9wcmnf719sgfkmf8ynb` FOREIGN KEY (`tipoAmbiente_idTipoAmb`) REFERENCES `tipoambiente` (`idTipoAmb`),
  ADD CONSTRAINT `FKlkb5wui1p2rm1spu1yushf6fh` FOREIGN KEY (`edificio_idEdificio`) REFERENCES `edificio` (`idEdificio`);

--
-- Limitadores para a tabela `cidade`
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `FKdvvk7e44v45yxfg4n6u1s98y2` FOREIGN KEY (`estado_idEstado`) REFERENCES `estado` (`idEstado`);

--
-- Limitadores para a tabela `pessoa`
--
ALTER TABLE `pessoa`
  ADD CONSTRAINT `FK31rn4jl0u0smx6m9kx45nrckq` FOREIGN KEY (`tipo_idTipo`) REFERENCES `tipopessoa` (`idTipo`),
  ADD CONSTRAINT `FK73exe60i580krixmc6mcl9rwj` FOREIGN KEY (`cidade_idCidade`) REFERENCES `cidade` (`idCidade`),
  ADD CONSTRAINT `FKke72oqk2bq25k8krl23i19ajk` FOREIGN KEY (`funcao_idFuncao`) REFERENCES `funcao` (`idFuncao`),
  ADD CONSTRAINT `FKn756mtef1bbaaki22794laa8g` FOREIGN KEY (`sexo_idSexo`) REFERENCES `sexo` (`idSexo`);
COMMIT;
